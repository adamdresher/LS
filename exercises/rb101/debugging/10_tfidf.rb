...
def idf(term, documents)
  ...
  # #/ returns an Integer unless the caller or object are a Float
...
# expected outputs:
puts tfidf("cat", document1, documents) # ~ 1.2 # before Float fix => 0.0
puts tfidf("cat", document2, documents) # ~ 1.6 # before Float fix => 0.0
...
puts tfidf("some", document2, documents) # ~ 0.4 # before Float fix => 0.0
puts tfidf("some", document3, documents) # ~ 0.4 # before Float fix => 0.0

# Further Exploration:
documents = [document2, document3]

puts tf("quantum", document2) # 0 because quantum is not in document2
puts tf("quantum", document3) # 0 because quantum is not in document3
puts idf("quantum", documents) # Infinity because Math.log(0) equals infinity

puts tfidf("quantum", document2, documents) # NaN (Not a Number)
puts tfidf("quantum", document3, documents) # NaN # 0 * Infinity is not a number
