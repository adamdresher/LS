...
=begin
Line 92 raises a `NoMethodError` due to `PostalService` not having access to
the method `#send` which is defined in the `Mailing` module.
This can be easily resolved by mixin in the `Mailing` module into
`PostalService`.
=end
